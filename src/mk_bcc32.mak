...
version.h:
	...
	cmd /S /C "echo #define DEFINE_FSEEKI64_AND_FTELLI64" >> version.h
	cmd /S /C "echo #define os_fseek _fseeki64" >> version.h
	cmd /S /C "echo #define os_ftell _ftelli64" >> version.h
	cmd /S /C "echo #define os_off_t __int64" >> version.h
	...
	cmd /S /C "echo puts("\043define INT64TYPE_SUFFIX_LL");" >> chkccomp.c
