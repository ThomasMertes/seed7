...
/**
 *  Take the bigIntValue from the parameters and call bigCmp().
 ...
 *          second.
 */
intType bigCmpValue (const rtlValueUnion value1, const rtlValueUnion value2)

  { /* bigCmpValue */
    return bigCmp(value1.bigIntValue, value2.bigIntValue);
  } /* bigCmpValue */
...
/**
 *  Take the bigIntValue from the parameters and call bigCpy().
 *  Function pointers in C programs generated by the Seed7 compiler
 *  may point to this function.
 */
void bigCpyValue (rtlValueUnion *const dest, const rtlValueUnion source)

  { /* bigCpyValue */
    bigCpy(&dest->bigIntValue, source.bigIntValue);
  } /* bigCpyValue */
...
/**
 *  Create bigIntValue function to be used via function pointers.
 *  Function pointers in C programs generated by the Seed7 compiler
 *  may point to this function.
 */
rtlValueUnion bigCreateValue (const rtlValueUnion source)
  ...
  /* bigCreateValue */
    ...
    result.bigIntValue = bigCreate(source.bigIntValue);
    return result;
  } /* bigCreateValue */
...
/**
 *  Take the bigIntValue from the parameter and call bigDestr().
 *  Function pointers in C programs generated by the Seed7 compiler
 *  may point to this function.
 */
void bigDestrValue (const rtlValueUnion old_value)

  { /* bigDestrValue */
    bigDestr(old_value.bigIntValue);
  } /* bigDestrValue */
...
/**
 *  Take the striValue from the parameter and call bigHashCode().
 *  Function pointers in C programs generated by the Seed7 compiler
 *  may point to this function.
 */
intType bigHashCodeValue (const rtlValueUnion aValue)

  { /* bigHashCodeValue */
    return bigHashCode(aValue.bigIntValue);
  } /* bigHashCodeValue */
