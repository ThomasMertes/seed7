...
/**
 *  Take the setValue from the parameters call setCmp().
 ...
 *          second.
 */
intType setCmpValue (const rtlValueUnion value1, const rtlValueUnion value2)

  { /* setCmpValue */
    return setCmp(value1.setValue, value2.setValue);
  } /* setCmpValue */
...
/**
 *  Take the setValue from the parameters and call setCpy().
 *  Function pointers in C programs generated by the Seed7 compiler
 *  may point to this function.
 */
void setCpyValue (rtlValueUnion *const dest, const rtlValueUnion source)

  { /* setCpyValue */
    setCpy(&dest->setValue, source.setValue);
  } /* setCpyValue */
...
/**
 *  Create setValue function to be used via function pointers.
 *  Function pointers in C programs generated by the Seed7 compiler
 *  may point to this function.
 */
rtlValueUnion setCreateValue (const rtlValueUnion source)
  ...
  /* setCreateValue */
    ...
    result.setValue = setCreate(source.setValue);
    return result;
  } /* setCreateValue */
...
/**
 *  Take the setValue from the parameter and call setDestr().
 *  Function pointers in C programs generated by the Seed7 compiler
 *  may point to this function.
 */
void setDestrValue (const rtlValueUnion old_value)

  { /* setDestrValue */
    setDestr(old_value.setValue);
  } /* setDestrValue */
...
/**
 *  Take the setValue from the parameter and call setHashCode().
 *  Function pointers in C programs generated by the Seed7 compiler
 *  may point to this function.
 */
intType setHashCodeValue (const rtlValueUnion aValue)

  { /* setHashCodeValue */
    return setHashCode(aValue.setValue);
  } /* setHashCodeValue */
...
/**
 *  Assign the symmetric difference of *dest and delta to *dest.
 *  @exception MEMORY_ERROR Not enough memory to create dest.
 */
void setSymdiffAssign (setType *const dest, const const_setType delta)
  ...
  /* setSymdiffAssign */
    logFunction(printf("setSymdiffAssign(\n");
                printSet(*dest);
                printf(",\n");
                printSet(delta);
                printf(")\n"););
