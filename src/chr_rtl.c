...
/**
 *  Take the charValue from the parameters and call chrCmp().
 ...
 *          second.
 */
intType chrCmpValue (const rtlValueUnion value1, const rtlValueUnion value2)

  { /* chrCmpValue */
    return chrCmp(value1.charValue, value2.charValue);
  } /* chrCmpValue */



/**
 *  Take the charValue from the parameters and assign source to dest.
 *  Function pointers in C programs generated by the Seed7 compiler
 *  may point to this function.
 */
void chrCpyValue (rtlValueUnion *const dest, const rtlValueUnion source)

  { /* chrCpyValue */
    dest->charValue = source.charValue;
  } /* chrCpyValue */
