...
/*  Changes: 2007, 2010, 2011, 2013 - 2016, 2018  Thomas Mertes     */
...
/**
 *  Take the bstriValue from the parameters and call bstCmp().
 ...
 *          second.
 */
intType bstCmpValue (const rtlValueUnion value1, const rtlValueUnion value2)

  { /* bstCmpValue */
    return bstCmp(value1.bstriValue, value2.bstriValue);
  } /* bstCmpValue */
...
/**
 *  Take the bstriValue from the parameters and call bstCpy().
 *  Function pointers in C programs generated by the Seed7 compiler
 *  may point to this function.
 */
void bstCpyValue (rtlValueUnion *const dest, const rtlValueUnion source)

  { /* bstCpyValue */
    bstCpy(&dest->bstriValue, source.bstriValue);
  } /* bstCpyValue */
 ...
 *  may point to this function.
 */
rtlValueUnion bstCreateValue (const rtlValueUnion source)
  ...
  /* bstCreateValue */
    ...
    result.bstriValue = bstCreate(source.bstriValue);
    return result;
  } /* bstCreateValue */
...
/**
 *  Take the bstriValue from the parameter and call bstDestr().
 *  Function pointers in C programs generated by the Seed7 compiler
 *  may point to this function.
 */
void bstDestrValue (const rtlValueUnion old_value)

  { /* bstDestrValue */
    bstDestr(old_value.bstriValue);
  } /* bstDestrValue */
...
/**
 *  Take the striValue from the parameter and call bstHashCode().
 *  Function pointers in C programs generated by the Seed7 compiler
 *  may point to this function.
 */
intType bstHashCodeValue (const rtlValueUnion aValue)

  { /* bstHashCodeValue */
    return bstHashCode(aValue.bstriValue);
  } /* bstHashCodeValue */
