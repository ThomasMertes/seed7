...
/**
 *  Take the listValue from the parameters and call rflCmp().
 ...
 *          second.
 */
intType rflCmpValue (const rtlValueUnion value1, const rtlValueUnion value2)

  { /* rflCmpValue */
    return rflCmp((const_listType) value1.listValue,
                  (const_listType) value2.listValue);
  } /* rflCmpValue */
...
/**
 *  Take the listValue from the parameters and call rflCpy().
 *  Function pointers in C programs generated by the Seed7 compiler
 *  may point to this function.
 */
void rflCpyValue (rtlValueUnion *const dest, const rtlValueUnion source)

  { /* rflCpyValue */
    rflCpy((listType *) &dest->listValue,
           (const const_listType) source.listValue);
  } /* rflCpyValue */
...
/**
 *  Create listValue function to be used via function pointers.
 *  Function pointers in C programs generated by the Seed7 compiler
 *  may point to this function.
 */
rtlValueUnion rflCreateValue (const rtlValueUnion source)
  ...
  /* rflCreateValue */
    ...
    result.listValue =
        (rtlListType) rflCreate((const_listType) source.listValue);
    return result;
  } /* rflCreateValue */
...
/**
 *  Take the listValue from the parameter and call rflDestr().
 *  Function pointers in C programs generated by the Seed7 compiler
 *  may point to this function.
 */
void rflDestrValue (const rtlValueUnion old_value)

  { /* rflDestrValue */
    rflDestr((listType) old_value.listValue);
  } /* rflDestrValue */
