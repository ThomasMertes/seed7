/********************************************************************/
/*                                                                  */
/*  drw_rtl.c     Platform independent drawing functions.           */
...
/**
 *  Take the winValue from the parameters and call drwCpy().
 *  Function pointers in C programs generated by the Seed7 compiler
 *  may point to this function.
 */
void drwCpyValue (rtlValueUnion *const dest, const rtlValueUnion source)

  { /* drwCpyValue */
    drwCpy(&dest->winValue, source.winValue);
  } /* drwCpyValue */
...
/**
 *  Create winValue function to be used via function pointers.
 *  Function pointers in C programs generated by the Seed7 compiler
 *  may point to this function.
 */
rtlValueUnion drwCreateValue (const rtlValueUnion source)
  ...
  /* drwCreateValue */
    ...
    result.winValue = drwCreate(source.winValue);
    return result;
  } /* drwCreateValue */
...
/**
 *  Take the winValue from the parameter and call drwDestr().
 *  Function pointers in C programs generated by the Seed7 compiler
 *  may point to this function.
 */
void drwDestrValue (const rtlValueUnion old_value)

  { /* drwDestrValue */
    drwDestr(old_value.winValue);
  } /* drwDestrValue */
