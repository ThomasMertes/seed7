...
install:
	...
	cd ../bin; ln -fs `pwd`/s7c.exe /usr/local/bin
	gzip -c ../doc/s7.1 > /usr/share/man/man1/s7.1.gz
	gzip -c ../doc/s7c.1 > /usr/share/man/man1/s7c.1.gz
	cd ../bin; ln -fs `pwd`/bas7.exe /usr/local/bin
	cd ../bin; ln -fs `pwd`/calc7.exe /usr/local/bin
	cd ../bin; ln -fs `pwd`/db7.exe /usr/local/bin
	cd ../bin; ln -fs `pwd`/diff7.exe /usr/local/bin
	cd ../bin; ln -fs `pwd`/find7.exe /usr/local/bin
	...
	cd ../bin; ln -fs `pwd`/toutf8.exe /usr/local/bin
