...
DOBJ = big_rtl.o big_gmp.o cmd_unx.o dll_unx.o fil_unx.o pcs_unx.o pol_sel.o tim_unx.o
OBJ = $(MOBJ)
...
DSRC = big_rtl.c big_gmp.c cmd_unx.c dll_unx.c fil_unx.c pcs_unx.c pol_sel.c tim_unx.c
SRC = $(MSRC)
