...
sql_db2.o: sql_db2.c
	$(CC) $(CPPFLAGS) $(DB2_INCLUDE_OPTION) $(CFLAGS) $(DB2_LIBS) $(LINKER_OPT_PARTIAL_LINKING) -o $@ $<
	$(OBJCOPY) $(OBJCOPY_PARAMS) $@

sql_ifx.o: sql_ifx.c
	$(CC) $(CPPFLAGS) $(INFORMIX_INCLUDE_OPTION) $(CFLAGS) $(INFORMIX_LIBS) $(LINKER_OPT_PARTIAL_LINKING) -o $@ $<
	$(OBJCOPY) $(OBJCOPY_PARAMS) $@

sql_srv.o: sql_srv.c
	$(CC) $(CPPFLAGS) $(SQL_SERVER_INCLUDE_OPTION) $(CFLAGS) $(SQL_SERVER_LIBS) $(LINKER_OPT_PARTIAL_LINKING) -o $@ $<
	$(OBJCOPY) $(OBJCOPY_PARAMS) $@
...
settings.h:
	...
	echo "#define MAKEFILE_NAME \"mk_icc.mak\"" >> settings.h
