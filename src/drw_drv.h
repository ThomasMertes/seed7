...
void drwPArc (wintype, inttype, inttype, inttype, floattype, floattype, inttype);
void drwFArcChord (wintype, inttype, inttype, inttype, floattype, floattype);
void drwPFArcChord (wintype, inttype, inttype, inttype, floattype, floattype, inttype);
void drwFArcPieSlice (wintype, inttype, inttype, inttype, floattype, floattype);
void drwPFArcPieSlice (wintype, inttype, inttype, inttype, floattype, floattype, inttype);
...
void drwPFEllipse (wintype, inttype, inttype, inttype, inttype, inttype);
void drwFlush (void);
