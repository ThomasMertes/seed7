...
static primactrecord prim_act_table[] = {
 ...
 /* { "DRW_SCALE",               drw_scale,               }, */
    ...
    { "POL_ADD_READ_CHECK",      pol_addReadCheck,        },
    { "POL_ADD_WRITE_CHECK",     pol_addWriteCheck,       },
    { "POL_CLEAR",               pol_clear,               },
    { "POL_CPY",                 pol_cpy,                 },
    ...
    { "POL_EMPTY",               pol_empty,               },
    { "POL_FILES",               pol_files,               },
    { "POL_HAS_NEXT_READ_FILE",  pol_hasNextReadFile,     },
    { "POL_HAS_NEXT_WRITE_FILE", pol_hasNextWriteFile,    },
    { "POL_NEXT_READ_FILE",      pol_nextReadFile,        },
    { "POL_NEXT_WRITE_FILE",     pol_nextWriteFile,       },
    { "POL_POLL",                pol_poll,                },
    { "POL_READY_FOR_READ",      pol_readyForRead,        },
    { "POL_READY_FOR_WRITE",     pol_readyForWrite,       },
    { "POL_REMOVE_READ_CHECK",   pol_removeReadCheck,     },
    { "POL_REMOVE_WRITE_CHECK",  pol_removeWriteCheck,    },
    { "POL_VALUE",               pol_value,               },
    ...
    { "REF_HSHKEYTOLIST",        ref_hshkeytolist,        },
    ...
    { "SOC_SELECT_INPUT",        soc_select_input,        },
    { "SOC_SEND",                soc_send,                },
