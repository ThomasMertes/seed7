...
static const actEntryRecord actEntryTable[] = {
    ...
    { "DRW_CMP",                 drw_cmp,                 },
    { "DRW_COLOR",               drw_color,               },
    { "DRW_CONVPOINTLIST",       drw_convPointList,       },
 ...
 /* { "DRW_SCALE",               drw_scale,               }, */
    ...
    { "FIL_NE",                  fil_ne,                  },
    { "FIL_OPEN",                fil_open,                },
    { "FIL_OPEN_NULL_DEVICE",    fil_openNullDevice,      },
    { "FIL_OUT",                 fil_out,                 },
    ...
    { "PCS_CHILD_STDERR",        pcs_childStdErr,         },
    { "PCS_CHILD_STDIN",         pcs_childStdIn,          },
    { "PCS_CHILD_STDOUT",        pcs_childStdOut,         },
    { "PCS_CMP",                 pcs_cmp,                 },
    { "PCS_CPY",                 pcs_cpy,                 },
    ...
    { "SQL_ERR_CODE",            sql_errCode,             },
    { "SQL_ERR_DB_FUNC",         sql_errDbFunc,           },
    { "SQL_ERR_LIB_FUNC",        sql_errLibFunc,          },
    { "SQL_ERR_MESSAGE",         sql_errMessage,          },
