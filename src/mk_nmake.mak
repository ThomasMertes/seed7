...
settings.h:
	...
	echo #define MAKEFILE_NAME "mk_nmake.mak" >> settings.h
...
esc2qte.exe: esc2qte.c
	$(CC) esc2qte.c -o esc2qte

sudo.exe: sudo.c
	$(CC) sudo.c -w -o sudo

depend: version.h setwpath.exe wrdepend.exe esc2qte.exe sudo.exe
	...
	.\wrdepend.exe OPTION=INFORMIX_INCLUDE_OPTION $(CFLAGS) -M sql_ifx.c ">> depend2"
