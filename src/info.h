...
#define CR_LIN_INFO()      printf("%6d\r", in_file.line)
#define NL_LIN_INFO()      printf("%6d\n", in_file.line)
#define CR_FIL_LIN_INFO()  printf("%6d %s\r", in_file.line, in_file.name)
#define NL_FIL_LIN_INFO()  printf("%6d %s\n", in_file.line, in_file.name)
