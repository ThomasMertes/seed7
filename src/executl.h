...
objecttype param1_call (objecttype, objecttype, errinfotype *);
objecttype param2_call (objecttype, objecttype, objecttype, errinfotype *);
objecttype param3_call (objecttype, objecttype, objecttype, objecttype, errinfotype *);
