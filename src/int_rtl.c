...
/**
 *  Take the intValue from the parameters and call uintCmp().
 ...
 *          second.
 */
intType uintCmpValue (const rtlValueUnion value1, const rtlValueUnion value2)

  { /* uintCmpValue */
    return uintCmp((uintType) value1.intValue,
                   (uintType) value2.intValue);
  } /* uintCmpValue */
...
/**
 *  Compare two rtlValueUnion values.
 *  @return -1, 0 or 1 if the first argument is considered to be
 *          respectively less than, equal to, or greater than the
 *          second.
 */
intType valueCmp (const rtlValueUnion value1, const rtlValueUnion value2)
  ...
  /* valueCmp */
    if (value1.genericValue < value2.genericValue) {
      signumValue = -1;
    } else {
      signumValue = value1.genericValue > value2.genericValue;
    } /* if */
    return signumValue;
  } /* valueCmp */
...
/**
 *  Copy function to be used via function pointers.
 ...
 *  Function pointers in C programs generated by the Seed7 compiler
 *  may point to this function. The function valueCpy is
 *  used from hashtables where the keys and the data is stored in
 *  rtlValueUnion data elements.
 */
...
/**
 *  Create function to be used via function pointers.
 *  This function is used to create new values for all types
 *  where a binary copy without special functionality can be used:
 *  E.g.: intType, floatType, charType, boolType.
 *  Function pointers in C programs generated by the Seed7 compiler
 *  may point to this function. The function valueCreate is
 *  used from hashtables where the keys and the data is stored in
 *  rtlValueUnion data elements. Some things must be considered:
 *  On some architectures (linux with gcc) functions with float
 *  results seem to be returned in a different way (may be another
 *  register). Therefore valueCreate (with rtlValueUnion) must be
 *  used even if sizeof(rtlValueUnion) == sizeof(floatType).
 */
...
/**
 *  Destr function to be used via function pointers.
 ...
 *  valueDestr is correct. This is important since some
 ...
 *  may point to this function.
 */
intType valueHashCode (rtlValueUnion aValue)
...
/**
 *  Take the ptrValue from the parameters and call ptrCmp().
 *  Function pointers in C programs generated by the Seed7 compiler
 *  may point to this function.
 *  @return -1, 0 or 1 if the first argument is considered to be
 *          respectively less than, equal to, or greater than the
...
intType ptrCmpValue (const rtlValueUnion value1, const rtlValueUnion value2)
  ...
  { /* ptrCmpValue */
    return ptrCmp(value1.ptrValue, value2.ptrValue);
  } /* ptrCmpValue */



/**
 *  Take the ptrValue from the parameters and assign source to dest.
 *  Function pointers in C programs generated by the Seed7 compiler
 *  may point to this function.
 */
void ptrCpyValue (rtlValueUnion *const dest, const rtlValueUnion source)
  ...
  { /* ptrCpyValue */
    dest->ptrValue = source.ptrValue;
  } /* ptrCpyValue */



/**
 *  Create ptrValue function to be used via function pointers.
 *  Function pointers in C programs generated by the Seed7 compiler
 *  may point to this function.
 */
rtlValueUnion ptrCreateValue (const rtlValueUnion from_value)
  ...
  /* ptrCreateValue */
    ...
    result.ptrValue = from_value.ptrValue;
    return result;
  } /* ptrCreateValue */
...
/**
 *  Take the genericValue from the parameter and compute the hashCode.
 *  Function pointers in C programs generated by the Seed7 compiler
 *  may point to this function.
 */
intType ptrHashCodeValue (const rtlValueUnion aValue)

  { /* ptrHashCodeValue */
    return (intType) (aValue.genericValue >> 6);
  } /* ptrHashCodeValue */
...
/**
 *  Take the intValue from the parameters and call intCmp().
 *  Function pointers in C programs generated by the Seed7 compiler
 *  may point to this function.
 *  @return -1, 0 or 1 if the first argument is considered to be
 *          respectively less than, equal to, or greater than the
 *          second.
 */
intType intCmpValue (const rtlValueUnion value1, const rtlValueUnion value2)

  { /* intCmpValue */
    return intCmp(value1.intValue, value2.intValue);
  } /* intCmpValue */
