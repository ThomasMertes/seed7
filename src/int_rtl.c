 ...
 *  even when sizeof(rtlGenerictype) != sizeof(inttype).
 */
 ...
 *  genericCreate (with rtlGenerictype) must be used even
 ...
 *  when sizeof(rtlGenerictype) != sizeof(rtlPtrtype).
 */
inttype ptrCmpGeneric (const rtlGenerictype value1, const rtlGenerictype value2)
...
void ptrCpyGeneric (rtlGenerictype *const dest, const rtlGenerictype source)
 ...
 *  when sizeof(rtlGenerictype) != sizeof(rtlPtrtype).
 */
rtlGenerictype ptrCreateGeneric (const rtlGenerictype from_value)
