  ...
  /* addStructElement */
    ...
    if (*err_info == OKAY_NO_ERROR && HAS_ENTITY(structElement)) {
      ...
      if (symbObject != NULL) {
        ...
        objectPtr.ptrValue = (rtlPtrType) symbObject;
        if (!hshContains(structSymbolsMap, objectPtr,
                         (intType) ((memSizeType) symbObject) >> 6,
                         (compareFuncType) &ptrCmpValue)) {
          oneValue.intValue = 1;
          hshIncl(structSymbolsMap, objectPtr, oneValue,
                  (intType) ((memSizeType) symbObject) >> 6,
                  (compareFuncType) &ptrCmpValue,
                  (createFuncType) &ptrCreateValue,
                  (createFuncType) &valueCreate,
                  (copyFuncType) &valueCpy);
...
/**
 *  Take the progValue from the parameters and call prgCpy().
 *  Function pointers in C programs generated by the Seed7 compiler
 *  may point to this function.
 */
void prgCpyValue (rtlValueUnion *const dest, const rtlValueUnion source)

  { /* prgCpyValue */
    prgCpy((progType *) &dest->ptrValue,
           (const progType) source.ptrValue);
  } /* prgCpyValue */
...
/**
 *  Create progValue function to be used via function pointers.
 *  Function pointers in C programs generated by the Seed7 compiler
 *  may point to this function.
 */
rtlValueUnion prgCreateValue (const rtlValueUnion source)
  ...
  /* prgCreateValue */
    ...
    result.ptrValue = (rtlPtrType) prgCreate((progType) source.ptrValue);
    return result;
  } /* prgCreateValue */
...
/**
 *  Take the progValue from the parameter and call prgDestr().
 *  Function pointers in C programs generated by the Seed7 compiler
 *  may point to this function.
 */
void prgDestrValue (const rtlValueUnion old_value)

  { /* prgDestrValue */
    prgDestr(old_value.ptrValue);
  } /* prgDestrValue */
