...
ISC_STATUS isc_attach_database (ISC_STATUS *status_vector,
                                ...
                                char *parm_buffer);
ISC_STATUS isc_blob_info (ISC_STATUS *status_vector,
...
ISC_STATUS isc_create_blob2 (ISC_STATUS *status_vector,
                             isc_db_handle *db_handle,
                             isc_tr_handle *trans_handle,
                             isc_blob_handle *blob_handle,
                             ISC_QUAD *blob_id,
                             short bpb_length,
                             char *bpb_address);
ISC_STATUS isc_create_database (ISC_STATUS *status_vector,
                                short db_name_length,
                                char *db_name,
                                isc_db_handle *db_handle,
                                short parm_buffer_length,
                                char *parm_buffer,
                                short db_type);
void isc_decode_sql_date (ISC_DATE *ib_date,
                          void *tm_date);
void isc_decode_sql_time (ISC_TIME *ib_time,
                          void *tm_date);
void isc_decode_timestamp (ISC_TIMESTAMP *ib_date,
                           void *tm_date);
...
ISC_STATUS isc_dsql_describe_bind (ISC_STATUS *status_vector,
                                   ...
                                   unsigned short da_version,
                                   XSQLDA *xsqlda);
ISC_STATUS isc_dsql_execute2 (ISC_STATUS *status_vector,
                              isc_tr_handle *trans_handle,
                              isc_stmt_handle *stmt_handle,
                              unsigned short da_version,
                              XSQLDA *in_xsqlda,
...
ISC_STATUS isc_dsql_prepare (ISC_STATUS *status_vector,
                             ...
                             XSQLDA *xsqlda);
ISC_STATUS isc_dsql_sql_info (ISC_STATUS *status_vector,
                              isc_stmt_handle *stmt_handle,
                              unsigned short item_length,
                              char *items,
                              unsigned short buffer_length,
                              char *buffer);
void isc_encode_sql_date (void *tm_date,
                          ISC_DATE *ib_date);
void isc_encode_sql_time (void *tm_date,
                          ISC_TIME *ib_time);
void isc_encode_timestamp (void *tm_date,
...
ISC_STATUS isc_get_segment (ISC_STATUS *status_vector,
                            ...
                            char *seg_buffer);
ISC_STATUS isc_interprete (char *buffer, ISC_STATUS **status_vector);
ISC_STATUS isc_open_blob2 (ISC_STATUS *status_vector,
                           isc_db_handle *db_handle,
                           isc_tr_handle *trans_handle,
                           isc_blob_handle *blob_handle,
                           ISC_QUAD *blob_id,
                           short bpb_length,
                           char *bpb_address);
ISC_INT64 isc_portable_integer (char *buffer,
                                short length);
