...
#define K_CTL_TAB    (KEYCODE_BASE + 146)
#define K_ALT_TAB    (KEYCODE_BASE + 147)
#define K_SFT_BS     (KEYCODE_BASE + 148)
#define K_CTL_BS     (KEYCODE_BASE + 149)
#define K_ALT_BS     (KEYCODE_BASE + 150)
...
#define K_CTL_PAD_CENTER (KEYCODE_BASE + 234)
#define K_SCRLUP         (KEYCODE_BASE + 235)
#define K_SCRLDN         (KEYCODE_BASE + 236)
#define K_INSLN          (KEYCODE_BASE + 237)
#define K_DELLN          (KEYCODE_BASE + 238)
#define K_ERASE          (KEYCODE_BASE + 239)
#define K_SFT_NL         (KEYCODE_BASE + 240)
#define K_CTL_NL         (KEYCODE_BASE + 241)
#define K_ALT_NL         (KEYCODE_BASE + 242)
#define K_ALT_DECIMAL    (KEYCODE_BASE + 243)
#define K_NULLCMD        (KEYCODE_BASE + 244)
#define K_REDRAW         (KEYCODE_BASE + 245)
#define K_MENU           (KEYCODE_BASE + 246)
...
#define K_SFT_MOUSE1     (KEYCODE_BASE + 254)
#define K_SFT_MOUSE2     (KEYCODE_BASE + 255)
#define K_SFT_MOUSE3     (KEYCODE_BASE + 256)
#define K_SFT_MOUSE4     (KEYCODE_BASE + 257)
#define K_SFT_MOUSE5     (KEYCODE_BASE + 258)
#define K_SFT_MOUSE_FWD  (KEYCODE_BASE + 259)
#define K_SFT_MOUSE_BACK (KEYCODE_BASE + 260)
#define K_CTL_MOUSE1     (KEYCODE_BASE + 261)
#define K_CTL_MOUSE2     (KEYCODE_BASE + 262)
#define K_CTL_MOUSE3     (KEYCODE_BASE + 263)
#define K_CTL_MOUSE4     (KEYCODE_BASE + 264)
#define K_CTL_MOUSE5     (KEYCODE_BASE + 265)
#define K_CTL_MOUSE_FWD  (KEYCODE_BASE + 266)
#define K_CTL_MOUSE_BACK (KEYCODE_BASE + 267)
#define K_ALT_MOUSE1     (KEYCODE_BASE + 268)
#define K_ALT_MOUSE2     (KEYCODE_BASE + 269)
#define K_ALT_MOUSE3     (KEYCODE_BASE + 270)
#define K_ALT_MOUSE4     (KEYCODE_BASE + 271)
#define K_ALT_MOUSE5     (KEYCODE_BASE + 272)
#define K_ALT_MOUSE_FWD  (KEYCODE_BASE + 273)
#define K_ALT_MOUSE_BACK (KEYCODE_BASE + 274)
#define K_SHIFT          (KEYCODE_BASE + 275)
#define K_LEFT_SHIFT     (KEYCODE_BASE + 276)
#define K_RIGHT_SHIFT    (KEYCODE_BASE + 277)
#define K_CONTROL        (KEYCODE_BASE + 278)
#define K_LEFT_CONTROL   (KEYCODE_BASE + 279)
#define K_RIGHT_CONTROL  (KEYCODE_BASE + 280)
#define K_ALT            (KEYCODE_BASE + 281)
#define K_LEFT_ALT       (KEYCODE_BASE + 282)
#define K_RIGHT_ALT      (KEYCODE_BASE + 283)
#define K_UNDEF          (KEYCODE_BASE + 284)
#define K_NONE           (KEYCODE_BASE + 285)
