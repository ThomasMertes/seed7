...
/**
 *  Take the typeValue from the parameters and call typCmp().
 ...
 *          second.
 */
intType typCmpValue (const rtlValueUnion value1, const rtlValueUnion value2)

  { /* typCmpValue */
    return typCmp((const_typeType) value1.typeValue,
                  (const_typeType) value2.typeValue);
  } /* typCmpValue */
...
intType typNum (typeType actual_type)
  ...
  /* typNum */
    ...
    if (unlikely(actual_type == NULL)) {
      ...
      typeNumber = (intType) hshIdxEnterGeneric(
