...
/**
 *  Create interfaceValue function to be used via function pointers.
 *  Function pointers in C programs generated by the Seed7 compiler
 *  may point to this function.
 */
rtlValueUnion itfCreateValue (const rtlValueUnion from_value)
  ...
  /* itfCreateValue */
    ...
    result.interfaceValue = itfCreate(from_value.interfaceValue);
    return result;
  } /* itfCreateValue */
